...
class Op {
  Op(int opcode, List args) {
    ...
    if (args.length == 4) {
      this.increaseCycleWhenCrossPage = args[3];
    }
  }

  late int opcode;
  late Instruction instruction;
  late AddressMode mode;
  late int cycles;
  bool increaseCycleWhenCrossPage = false;
}

final Map<int, List<dynamic>> OP_ARGS_TABLE = {
